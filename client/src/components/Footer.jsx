      ...
      <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-4 mid:gap-6 gap-2 md:gap-10">
        ...
        <div>
          <div className="flex items-center gap-2   md:mb-3">
            ...
            />
            <h2 className="font-bold text-lg md:text-xl text-white">IndiaCulture</h2>
          </div>
          ...
          <div className="flex gap-3 mt-1 md:mt-4">
            <a href="https://www.instagram.com/_indiaculture_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="w-7 h-7 md:w-8 md:h-8 flex items-center justify-center bg-gray-800 rounded hover:bg-gray-600">
              <FaInstagram />
            </a>
  ...
  <ul className="space-y-1 md:space-y-2 text-xs md:text-sm">
    ...
    <li>
      <Link to="/logout" className="hover:underline">Logout</Link>
        ...
        <div>
          ...
          <ul className="space-y-1 md:space-y-2 text-xs md:text-sm">
            ...
            <li><a href="mailto:indiaculture24@gmail.com" className="text-white font-medium">Order Tracking</a></li>
            <li className="mt-1 flex items-center gap-2 text-xs md:text-sm">
              <FaEnvelope className="text-[#d19a74]" /> indiaculture24@gmail.com
            </li>
            <li className="mt-1 flex items-center gap-2 text-xs md:text-sm">
        ...
        {/* Contact */}
        <div>
          <h3 className="text-base md:text-lg font-semibold text-white mb-2 md:mb-3">IndiaCulture</h3>
          <p className="text-xs md:text-sm leading-5 md:leading-6">
      ...
      <div className="bg-black py-2 md:py-3 text-center text-xs md:text-sm text-gray-400">
        <p>© 2025 Indiaculture. All rights reserved.</p>
        <p>Made By Procols.</p>
      </div>
    </footer>
  );
