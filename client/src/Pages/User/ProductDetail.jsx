              ...
              {product.images?.map((img, i) => (
                <SwiperSlide key={i}>
                  <img
                    src={img.url}
                    alt={`${product.name} ${i}`}
                    className="w-full h-[50vw] max-h-[300px] sm:h-[350px] md:h-[400px] object-contain rounded"
                  />
                </SwiperSlide>
              ))}
            </Swiper>
              ...
              {product.images?.map((img, i) => (
                <SwiperSlide key={i}>
                  <img
                    src={img.url}
                    alt={`Thumb ${i}`}
                    className="w-full h-16 sm:h-20 md:h-24 object-cover rounded cursor-pointer"
                  />
                </SwiperSlide>
              ))}
            </Swiper>
